...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-22 20:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b5617512-cdbf-4220-be79-cee0d6d4392c.git
$ cd b5617512-cdbf-4220-be79-cee0d6d4392c
```
